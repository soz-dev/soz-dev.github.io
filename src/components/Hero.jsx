    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden grid-pattern">
      ...
      <div className="relative z-10 px-8 lg:px-12" style={{ maxWidth: '860px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full glass border border-purple-500/25 text-xs font-mono text-slate-400 mb-10"
        >
        ...
        >
          <h1 className="text-[clamp(3rem,10vw,7rem)] font-bold leading-[0.95] tracking-tight mb-8">
            <span className="text-white block">Je conçois des</span>
            ...
            <span className="text-white block">qui marquent.</span>
          </h1>
        </motion.div>
          ...
          <div className="overflow-hidden h-7 flex items-center">
            <AnimatePresence mode="wait">
              <motion.span
                ...
                className="text-slate-300 text-lg font-medium block"
              >
        ...
        >
          ...
          <a
            href="#contact"
            className="px-8 py-3.5 rounded-full glass border border-white/10 text-slate-300 text-sm font-medium hover:border-white/25 hover:text-white transition-all duration-300"
          >
            Me contacter →
          </a>
        </motion.div>
      ...
      >
        <span className="text-xs font-mono text-slate-700 tracking-[0.3em] uppercase">scroll</span>
        <motion.div
