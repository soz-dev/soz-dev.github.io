...
export const SECTIONS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'logo', label: 'Logo', type: 'radio', options: ['Oui, j\'ai un logo', 'Non – à créer (+300€)', 'Partiel – à refaire'] },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'contenu_existant', label: 'Textes & images disponibles', type: 'radio', options: ['Oui, tout est prêt', 'Partiellement', 'Non, à créer'] },
      {
        ...
        options: ['Français', 'Anglais (+300€)', 'Espagnol', 'Autre'],
      },
      { id: 'blog', label: 'Blog / actualités', type: 'radio', options: ['Oui (+200€)', 'Non'] },
    ],
  },
  {
    id: 'fonctionnalites',
    ...
    questions: [
      {
        ...
        options: [
          ...
          'Carte interactive / Maps (+200€)',
          'Chat en direct (+300€)',
          'Newsletter (+150€)',
          'Notifications push (+200€)',
          'Recherche avancée (+300€)',
          'Géolocalisation (+200€)',
          'Export PDF / rapports (+300€)',
        ],
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'livraison', label: 'Gestion livraison / retours', type: 'radio', options: ['Oui (+300€)', 'Non'] },
    ],
  },
  {
    id: 'technique',
